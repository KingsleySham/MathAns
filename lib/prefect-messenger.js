...
async function maybeRedirect({ key, replyTo }) {
  ...
  await safeSendText(replyTo,
    "This is the Prefect Board's automated duty line — messages here aren't read. " +
    `For any enquiries, please contact ${enquiryPhone()}. The duty reminder buttons still work as normal.`);
}
