...
// prefect who might turn up, and the board asks in the group chat anyway. That
// includes anyone rostered who has declined — they get the weather like
// everyone else.
//
// Sent with the prefect_duty_reminder_weather template (VHP decision, Aug
// 2026). {{gate}}/{{time}}/{{day}} describe *the day's duty*, taken from the
// roster entry, not the reader's own assignment — so the body must stay worded
// for a board-wide audience. If it goes back to second person ("You'll be
// having duty at …"), every non-rostered prefect is told to turn up. Template
// wording is edited in Meta and re-reviewed there, not here.
//
