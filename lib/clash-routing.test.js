...
test('two lessons can be ticked off in one reply', async () => {
  ...
  assert.equal(body.tutorial_1, '3️⃣ Thursday 6:30pm - Math', 'only the untouched lesson is still a clash');
  assert.equal(body.tutorial_arranged, '1️⃣ Tuesday 6pm - Japanese · 2️⃣ Wednesday 6pm - Piano');
});
