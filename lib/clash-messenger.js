...
export async function planClash({
  events = [], codes = null, makeups = null, skips = [], allowDisplacing = true,
} = {}) {
...
export async function openClash({
  codes = null, makeups = null, skips = [], events = [], day, via = 'web', note = '', allowDisplacing = true,
} = {}) {
  const plan = await planClash({ events, codes, makeups, skips, allowDisplacing });
